...
public class AE2ExtrasStorageCellModels {
    ...
    private static final Identifier MODEL_CELL_ITEMS_1K = Identifier.parse(
            "ae2:block/drive/cells/1k_item_cell");
    private static final Identifier MODEL_CELL_ITEMS_4K = Identifier.parse(
            "ae2:block/drive/cells/4k_item_cell");
    private static final Identifier MODEL_CELL_ITEMS_16K = Identifier.parse(
            "ae2:block/drive/cells/16k_item_cell");
    private static final Identifier MODEL_CELL_ITEMS_64K = Identifier.parse(
            "ae2:block/drive/cells/64k_item_cell");
    private static final Identifier MODEL_CELL_ITEMS_256K = Identifier.parse(
            "ae2:block/drive/cells/256k_item_cell");
    private static final Identifier MODEL_CELL_FLUIDS_1K = Identifier.parse(
            "ae2:block/drive/cells/1k_fluid_cell");
    private static final Identifier MODEL_CELL_FLUIDS_4K = Identifier.parse(
            "ae2:block/drive/cells/4k_fluid_cell");
    private static final Identifier MODEL_CELL_FLUIDS_16K = Identifier.parse(
            "ae2:block/drive/cells/16k_fluid_cell");
    private static final Identifier MODEL_CELL_FLUIDS_64K = Identifier.parse(
            "ae2:block/drive/cells/64k_fluid_cell");
    private static final Identifier MODEL_CELL_FLUIDS_256K = Identifier.parse(
