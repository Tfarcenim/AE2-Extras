...
public class AE2Extras {
    ...
    public static Item createMonoItemCell(StorageTier tier, Supplier<Item> cell) {
        return new MonoStorageCellItem(noStack(), cell.get(), AEItems.CALCULATION_PROCESSOR, tier.idleDrain(), tier.bytes() / AE2Extras.KILO,
                1, 1, AEKeyType.items());
    }
    ...
    private void common(FMLCommonSetupEvent e) {
        ...
        BlockEntityType<CraftingBlockEntity> craftingStorage = AEBlockEntities.CRAFTING_STORAGE;
        ...
        BlockEntityType<EnergyCellBlockEntity> energyCell = AEBlockEntities.ENERGY_CELL;
