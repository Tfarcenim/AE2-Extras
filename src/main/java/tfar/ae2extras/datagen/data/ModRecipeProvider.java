...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void monoCell(Consumer<FinishedRecipe> consumer,Item cell,Item result){
    ...
    protected void cellComponent(Consumer<FinishedRecipe> consumer, Item previous, TagKey<Item> addition, Item processor, Item result) {
