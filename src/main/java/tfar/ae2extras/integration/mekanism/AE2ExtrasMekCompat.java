...
public class AE2ExtrasMekCompat {
    ...
    public static Item createChemicalCell(StorageTier storageTier) {
        return new ChemicalStorageCell(AE2Extras.noStack(),storageTier,AMItems.CHEMICAL_CELL_HOUSING.get());
    }

    public static PortableCellItem createPortableChemicalCell(StorageTier storageTier) {
        return new ChemicalPortableCellItem(18, AMMenus.PORTABLE_CHEMICAL_CELL_TYPE, storageTier, AE2Extras.noStack(), 0);
    }
